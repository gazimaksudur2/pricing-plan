...
const PlanPage = () => {
  return (
    <div className="p-4 md:w-[90%] lg:w-[80%] mx-auto">
      <section class="bg-white">
        <div class="container px-6 py-8 mx-auto">
          <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="overflow-hidden p-0.5 mt-6 border rounded-lg">
              <div class="sm:-mx-0.5 flex">
                ...
                <button class=" focus:outline-none px-3 w-1/2 sm:w-auto py-1 sm:mx-0.5 text-gray-800 bg-transparent rounded-lg hover:bg-gray-200">
                  Yearly
                </button>
              </div>
            </div>
          ...
          <div class="grid gap-6 mt-16 -mx-6 sm:gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <div class="px-6 py-4 transition-colors duration-300 transform bg-gray-700 rounded-lg">
